const TRANSLATIONS = {
  ...
  SIGNUP_SUCCESS: {
    ko: "회원가입이 성공적으로 완료되었습니다.",
    en: "Membership registration has been completed successfully.",
  },
  SIGNIN_SUCCESS: {
    ko: "로그인 되었습니다.",
  ...
  //   validate
  VALI_PASSWORD_CONFIRM_CHECK: {
    ko: "비밀번호와 비밀번호 확인 값이 다릅니다.",
    en: "The password and password confirmation values ​​are different.",
  },
  VALI_PASSWORD_CHECK: {
